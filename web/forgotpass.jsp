                        ...
                        <div class="d-table-cell align-middle">
                            ...
                            <div class="card">
                                <div class="card-body row">
                                    <div class="col-md-12">
                                        <form>
                                            <div> <img src="https://tatthanh.com.vn/pic/Images/Module/News/images/image(1722).png" width="100px" style="border-radius: 50%;" alt="alt"/></div>
                                            <div>
                                            ...
                                            <div class="text-center mt-3">
                                                <a href="index.html" class="btn btn-lg btn-secondary" style="border-radius: 50px;">Send email</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
