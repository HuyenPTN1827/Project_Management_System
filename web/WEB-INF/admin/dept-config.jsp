        ...
        <script>
            ...
            function openDepartmentModal(id = null) {
                ...
                fetch(url)
                        ...
                        .then(data => {
                            document.querySelector('#departmentModal .modal-body').innerHTML = data;
            ...
            <jsp:include page="../component/sidebar-admin.jsp"></jsp:include>
                ...
                <jsp:include page="../component/header.jsp"></jsp:include>
                    ...
                    <main class="content">
                        ...
                        <div class="mt-2 mb-3">
                            <h1 class="h1 d-inline align-middle">Department Configs</h1>
                        </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <button type="button" class="close btn btn-danger" data-dismiss="modal" aria-label="Close" onclick="closedeptUserModal();">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                            ...
                                            <tbody>
                                                <c:forEach items="${requestScope.deptUser}" var="du">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <c:if test="${du.status eq 'false'}">
<!--                                                                <a href="<%=request.getContextPath()%>/edit-department-user?id=${du.id}&deptId=${dept.id}"
                                                                   class="btn btn-link text-primary">Edit</a>-->

                                                                <a href="javascript:void(0);" class="btn btn-link text-primary" 
                                                                   onclick="openDeptUserModal(${dept.id}, ${du.id});">Edit</a>
