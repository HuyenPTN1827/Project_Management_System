                                            ...
                                            <form action="ProjectTypeSetting" method="post" class="row">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="type" placeholder="Enter the Project Type Setting type" 
                                                           value="${projectType.type}" required>
                                                </div>
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="value" placeholder="Enter the Project Type Setting value" 
                                                           value="${projectType.value}" required>
                                                </div>
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="number" class="form-control" name="priority" placeholder="Enter the Project Type Setting priority" 
                                                           value="${projectType.priority}" required>
                                                </div>
                                                <div class="mb-3 col-md-12">
                                                    <label class="form-label">Description</label>
                                                    <textarea class="form-control" name="description" 
                                                              placeholder="Enter the Project Type details" rows="3">${projectType.description}</textarea>
                                                </div>
                                                <div class="mb-3 col-md-12">
                                                    <label class="form-label">Status ${projectType.status}</label>
                                                    <input type="radio" name="status" ${projectType.status eq 'true'?'checked':''} class="form-checkbox"  value="true" /> Active 
                                                    <input type="radio" name="status"  ${projectType.status eq 'false'?'checked':''} class="form-checkbox" value="false" /> Inactive 
                                                </div>
                                                <div>
