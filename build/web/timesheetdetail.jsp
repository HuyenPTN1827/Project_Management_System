            ...
            <jsp:include page="./layout/sidebar.jsp"></jsp:include>
                ...
                <main class="content">
                    <div class="container-fluid p-0">
                        ...
                        <h1 class="h3 mb-3"> Timesheet Detail</h1>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="row">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label" for="inputName">Work Package*</label>
                                                <input type="text" class="form-control" id="inputName" value="Issue #3" placeholder="">
                                            </div>

                                            <div class="mb-3 col-md-6">
                                                <label class="form-label" for="inputName">Task*</label>
                                                <input type="text" class="form-control" id="Description" value="Issue Description 123"  placeholder="">
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label" for="inputName">Related Team*</label>
                                                <input type="text" class="form-control" id="Assignee" value="Marketing" placeholder="">
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label" for="inputName">Process*</label>
                                                <input type="text" class="form-control" id="Assignee" value="Marketing" placeholder="">
                                            </div>
                                            <div class="mb-3 col-md-6">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label" for="inputName">Task Duration*</label>
                                                <input type="number" step="0.1" class="form-control" id="Project" value="2.5"  placeholder="">
                                            </div>
                                            <div>
