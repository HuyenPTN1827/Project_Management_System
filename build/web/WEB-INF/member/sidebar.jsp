    ...
    <div class="d-flex justify-content-center">
        ...
        <div class="flex-grow-1 ps-2">
            ...
            <div class="dropdown-menu dropdown-menu-start">
                <a class="dropdown-item" href="<%= request.getContextPath() %>/member-profilecontroller"><i class="align-middle me-1" data-feather="user"></i> View Profile</a>
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item active">
                <a class="sidebar-link" href="member-profilecontroller">
